...
For more examples and documentation, visit this repo's [GitHub Pages site](https://ecohealthalliance.github.io/yenpathy/).
...
Further examples can be found in the Package's vignette. This can be found on the package's GitHub Pages site, or viewed in R;
