...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(k_shortest_paths(start_vertex, end_vertex, k, vertex_num, graph_df, verbose));
...
static const R_CallMethodDef CallEntries[] = {
    {"_yenpathy_k_shortest_paths", (DL_FUNC) &_yenpathy_k_shortest_paths, 6},
